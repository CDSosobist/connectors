...
//        conn.executeQuery(positionObjectClass, null, rh, null);
    ...
    public void testCreateUser() {
        ...
        set.add(AttributeBuilder.build(ACC_CNUM, "bs67230935"));
        set.add(AttributeBuilder.build(ACC_DEP_ID, "bs67200101"));
        set.add(AttributeBuilder.build(ACC_END_DATE, "31.12.2020"));
        set.add(AttributeBuilder.build(ACC_GENDER, "1"));
        set.add(AttributeBuilder.build(ACC_JOB_ID, "jb986532"));
        ...
        set.add(AttributeBuilder.build(ACC_UID, "bs67230935"));
    ...
    public void testUpdateUser() {
        Set<Attribute> set = new HashSet<>();
        String gguid = "777555333";
        set.add(AttributeBuilder.build(Name.NAME, gguid));
        set.add(AttributeBuilder.build(Uid.NAME, gguid));

        set.add(AttributeBuilder.build(ACC_FNAME, "Шурумбек"));
        set.add(AttributeBuilder.build(ACC_LNAME, "Эбокукин"));
        set.add(AttributeBuilder.build(ACC_MNAME, "Копатыч"));
        set.add(AttributeBuilder.build(ACC_BEG_DATE, "01.01.2019"));
        set.add(AttributeBuilder.build(ACC_BIRTH_DATE, "01.01.1980"));
        set.add(AttributeBuilder.build(ACC_CNUM, "bs67025389"));
        set.add(AttributeBuilder.build(ACC_DEP_ID, "bs67200101"));
        set.add(AttributeBuilder.build(ACC_END_DATE, "31.12.2020"));
        set.add(AttributeBuilder.build(ACC_GENDER, "1"));
        set.add(AttributeBuilder.build(ACC_JOB_ID, "jb986532"));
        set.add(AttributeBuilder.build(ACC_ORG_ID, "bs67200098"));
        set.add(AttributeBuilder.build(ACC_PHOTO, ""));
        set.add(AttributeBuilder.build(ACC_UID, "bs67200184"));
