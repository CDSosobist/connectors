...
public class companyStructureHandler {

    static final String CS_COMPANY_UID = "Ref_Key";
    static final String CS_DEL_MARK = "DeletionMark";
    static final String CS_PARENT_KEY = "Parent_Key";
