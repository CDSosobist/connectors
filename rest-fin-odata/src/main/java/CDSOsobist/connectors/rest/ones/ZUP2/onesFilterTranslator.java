...
class onesFilterTranslator extends AbstractFilterTranslator<onesFilter> {
    private static final Log LOG = Log.getLog(onesFilterTranslator.class);

    public onesFilterTranslator() {
    }

    protected onesFilter createEqualsExpression(EqualsFilter filter, boolean not) {
