...
public class rxptFilterTranslator extends AbstractFilterTranslator<rxptFilter> {

    private static final Log LOG = Log.getLog(rxptFilterTranslator.class);

    public rxptFilterTranslator() {

    }

    protected rxptFilter createEqualsExpression(EqualsFilter filter, boolean not) {
